    ...
    function () {
      ...
      _createClass(MeteoService, [{
        ...
        value: function getForcast(name) {
          console.log('from service', name);
          var m = new _meteoItem__WEBPACK_IMPORTED_MODULE_2__["MeteoItem"]();
          return fetch('https://api.openweathermap.org/data/2.5/forecast/?q=' + name + '&units=metric&lang=fr&appid=0ada432b59deb9716c357092c5f79be6').then(function (response) {
            return response.json();
          }).then(function (json) {
            if (json.cod == "200") {
